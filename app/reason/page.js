        ...
        {result && (
          <section style={s('margin-top:20px;background:#141416;border:1px solid #26262a;border-radius:12px;overflow:hidden;')}>
            <div style={s('padding:16px 20px;border-bottom:1px solid #1a1a1d;')}>
              <div style={s('font-size:13px;font-weight:700;color:#9a9aa3;text-transform:uppercase;letter-spacing:.04em;margin-bottom:6px;')}>Reason for appointment</div>
              <div style={s('display:flex;align-items:flex-start;gap:12px;')}>
                <p style={s('flex:1;margin:0;font-size:18px;font-weight:700;color:#e9e9ec;line-height:1.4;word-break:break-word;')}>{result.reason || '—'}</p>
            ...
            {result.details && result.details.length > 0 && (
              <div style={s('padding:14px 20px;')}>
                <div style={s('font-size:13px;font-weight:700;color:#9a9aa3;text-transform:uppercase;letter-spacing:.04em;margin-bottom:8px;')}>Detail</div>
                <ul style={s('margin:0;padding:0 0 0 20px;display:flex;flex-direction:column;gap:6px;font-size:16px;color:#e9e9ec;')}>
