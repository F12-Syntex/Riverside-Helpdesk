...
// obvious why an entry is in the list. This sheet is the only place the
// directory is searched now: the Contact mode, which put the same list on the
// page itself, went with the rest of the modes.
