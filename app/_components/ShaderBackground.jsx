...
void main() {
  ...
  vec3 col = u_base;
  col = mix(col, u_c2, wLight * 0.46);
  col = mix(col, u_c1, wBlue  * 0.34);
  col = mix(col, u_c3, wAqua  * 0.20);
  ...
  col = mix(u_base, col, 0.35 + 0.65 * foot);
...
const FALLBACK =
  'radial-gradient(60% 55% at 82% 8%, rgba(65,182,230,.34) 0%, rgba(65,182,230,0) 70%),' +
  'radial-gradient(55% 60% at 10% 90%, rgba(0,94,184,.22) 0%, rgba(0,94,184,0) 70%),' +
  'radial-gradient(45% 45% at 60% 60%, rgba(0,164,153,.12) 0%, rgba(0,164,153,0) 70%),' +
  '#f6f9fb';
