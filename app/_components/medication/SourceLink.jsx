...
export default function SourceLink({ url, title }) {
  ...
  return (
    <Hover
      ...
      base="margin-top:8px;display:inline-flex;align-items:center;gap:6px;max-width:100%;background:#fff;border:1px solid #cfe1f0;border-radius:999px;padding:4px 11px;font:inherit;font-size:12.5px;font-weight:600;color:#005eb8;cursor:pointer;text-decoration:none;"
