...
export default function JudgementChip({ label = 'AI judgement, not from the practice’s documents' }) {
  return (
    <span style={s('margin-top:8px;display:inline-flex;align-items:center;gap:7px;max-width:100%;background:#171719;border:1px solid #4b3d1f;border-radius:999px;padding:4px 12px 4px 9px;font-size:12.5px;font-weight:600;color:#e0b85f;')}>
      <Svg w={13} stroke="#e0b85f" sw={2.2} style={s('flex:none;')}>{Icons.sparkle}</Svg>
