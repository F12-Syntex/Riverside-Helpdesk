...
export default function CiteChip({ label, onClick }) {
  return (
    <Hover onClick={onClick} className="riva-lift" title="Open the source"
      base="margin-top:8px;display:inline-flex;align-items:center;gap:7px;max-width:100%;background:#fff;border:1px solid #dde4e7;border-radius:999px;padding:5px 12px 5px 10px;font:inherit;font-size:13.5px;font-weight:600;color:#4c6272;cursor:pointer;transition:border-color .16s ease,background-color .16s ease,color .16s ease;"
