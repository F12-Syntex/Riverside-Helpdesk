...
export const BROWSE_AREAS = [
  { id: 'urgent', label: 'Urgent and emergency', icon: 'triangle', bg: '#f6dedc', color: '#d5281b', border: '#f1c7c2', hoverBorder: '#d5281b' },
  ...
  { id: 'tasks', label: 'Tasks and messages', icon: 'send', bg: '#e8edee', color: '#4c6272' },
  { id: 'shortcuts', label: 'Shortcuts and templates', icon: 'keyboard', bg: '#ebe6f1', color: '#330072' },
];
