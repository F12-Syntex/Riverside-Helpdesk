...
// Canonical knowledge store. Documents, Notebook pages and contacts all use the
// same entry/passages model; `kind` only controls how they are edited/rendered.
// PostgreSQL full-text search supplies fast exact retrieval and pgvector supplies
// semantic retrieval. Atomic claims and conflicts make disagreements reviewable
// instead of silently asking the model to choose a source.
