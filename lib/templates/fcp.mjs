...
import { matchSpan, spanWithin } from '../safety/spans.mjs';
...
const FEATURES = [
  ['msk', MSK_REGION],
  ['caudaEquina', CAUDA_EQUINA],
  ['nerveRoot', NERVE_ROOT],
  ['selfcareFailed', SELFCARE_FAILED],
  ['severe', SEVERE_IMPACT],
  ['asked', ASKS_FOR_PHYSIO],
...
export const ASSERTED_FEATURES = ['nerveRoot', 'selfcareFailed', 'severe', 'asked', 'otcTreatment'];
