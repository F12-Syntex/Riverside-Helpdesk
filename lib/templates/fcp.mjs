  ...
  return answer({
    ...
    blocks: [
      fields([
        ...
        // A RULE TO CHECK, NOT A FACT ABOUT THIS PATIENT. It read "16 and over
        // only" beside a card that had already decided this was "a
        // musculoskeletal problem in an adult" — about a message that never
        // gave an age. Printed as an assertion, it clears the gate it exists to
        // hold; printed as a question, it makes somebody ask.
        field('Check age first', 'FCPs take 16 and over — ask before booking'),
      ], 'Where this goes'),
