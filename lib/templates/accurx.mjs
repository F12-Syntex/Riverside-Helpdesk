...
export function accurxAnswer({
  ...
  return answer({
    ...
    blocks: hoist
      ? [where, ...why, ...wording, ...continuity, conflicts, flags, panel, ...blocks.slice(1), clinicNote(clinics), couldNotRead, ...wordingRules(), footer(why.length > 0)]
      : [...blocks, handover, ...why, ...wording, ...continuity, conflicts, flags, panel, clinicNote(clinics), couldNotRead, ...wordingRules(), footer(why.length > 0)],
