...
const HOW = {
  ...
  pharmacy: [
    ...
    'Reply in AccuRx with the **Pharmacy First message template**, with **Dr R Goel’s name** beneath the message.',
    'For a self-care condition, explain that medicines that can be bought are **not routinely prescribed** — the pharmacist will send them back to us if it needs more.',
  ],
  pharmacyTeam: [
...
/** The steps for actioning a destination, where the guide has any. */
export const howTo = (id) => HOW[String(id || '')] || [];
