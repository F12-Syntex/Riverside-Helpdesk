...
//   emailForm
//            an emailed referral: the doctor's form, and optionally the
//            address and notes.
//   pathology
...
// An emailed referral from a Notebook note, said as one sentence: send the
// form the doctor created by email. The address and the notes are optional,
// and an empty one is left off the card rather than drawn as a gap.
export const emailForm = ({ form = '', to = '', notes = '' } = {}) => ({ type: 'emailForm', form, to, notes });
