...
export const field = (label, value, { missing = '', copy = false } = {}) => (
  copy ? { label, value, missing, copy: true } : { label, value, missing }
);
...
// what it was before this existed.
export const answer = ({ title, subtitle = '', blocks, source = [], warn = '', destination = '' }) => ({
  title,
  subtitle,
