...
import { appointmentBookingAnswer, appointmentReasonAnswer, codedDocumentAnswer, documentCodingAnswer } from './writing.mjs';
...
export const TEMPLATES = [
...

  {
    ...
    sample: '/document Discharge summary, Homerton Ophthalmology, 07-Aug-2026, discharged',
...

  {
    ...
    group: 'Writing',
    label: 'Reason and booking notes',
    why: 'The reason rules drop "call after 2pm" on purpose. It still decides which slot gets booked, so it has somewhere to go instead of the floor.',
    sample: '/appt heartburn 3 weeks, gaviscon not helping, worried about omeprazole with my clopidogrel, best to call after 2pm, I will need a Turkish interpreter',
    render: () => appointmentBookingAnswer({
