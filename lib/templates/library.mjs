...
export const TEMPLATES = [
  ...
  },
  {
    ...
    group: 'Procedures',
    label: 'Blood form — a review with no form recorded',
    why: 'The practice has recorded one filled-in form, and a diabetes review is not it. The screen is still the answer to where this goes; the ticks are not, so nothing is ticked and the gap is flagged for the practice. Copying the health-check panel over would be a patient bled for the wrong tests.',
    sample: 'Which tests go on the blood form for a diabetes review?',
    render: () => bloodFormAnswer({ check: 'diabetes review' }),
  },
  {
    id: 'documentCoding',
    group: 'Writing',
