...
export function selectionPrompt({ question, attached = '' }) {
  ...
  return [
    ...
    '',
    '6. "none" — anything else. Choose it freely: another part of the assistant answers those, and forcing a template that does not fit produces a confident answer to a question nobody asked.',
    '',
