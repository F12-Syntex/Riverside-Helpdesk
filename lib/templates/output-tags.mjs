...
export const OUTPUT_TAGS = [
  {
    ...
    schema: z.object({
      ...
      hospital: z.string().default('').describe('The organisation or site the page says to choose — "Homerton University Hospital", "must contain Telederm". Empty if the page does not say.'),
