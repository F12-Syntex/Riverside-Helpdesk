...
export const REASON_RULES = [
  ...
  'Lowercase clinical shorthand: pt, req, bk’d, hx, inj, bilat, ?condition, sx, wks, yday, tmrw, f/u, abx, meds.',
...
const REASON_EXAMPLES = [
  {
    ...
    to: 'pt req r/v heartburn; 3 wks, worsening, gaviscon not helping; on clopidogrel, pt concerned re omeprazole interaction',
  },
  {
    ...
    to: 'pt req physio; knee pain 2 months since fall from bike, pt attributes to twisting on landing',
  },
];
