...
const CONSULTATION_EXAMPLES = [
  ...
  {
    from: 'Rang the patient to book them in for the fever, cough with mucus and sore throat they wrote in about — a week now and no better, and they are asking for antibiotics. No answer, so I will book them in for Friday.',
    parts: { contact: 'tel pt re appt, no answer', summary: 'fever, cough w/ mucus, sore throat 1/52 unchanged, req abx', actions: ['to book appt Fri'], safetyNet: '' },
  },
  {
...
export function consultationNoteRulesAnswer() {
  return answer({
    ...
    blocks: [
      ...
      bullets([
        'How the contact happened, who started it, and how it ended if the patient was not reached',
        'Every symptom the note names, all of them, in the order they were written',
        'How long it has gone on and which way it is going — "1/52 unchanged", "3/7 worsening"',
        'What has been tried, and what the patient asked for in their own terms',
        'What was done: booked, tasked, advised, referred, messaged, chased, declined — with who and when',
        'What is still to happen, where the note says so — "to book appt Fri"',
