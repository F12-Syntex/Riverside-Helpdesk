...
const DESCRIBERS = {
  ...
  // Reading the log OF questions is routine chatter, not a question — /stats
  // fetches it again on every filter change.
  '/api/questions': () => ({ kind: 'load', label: 'Read the question log' }),
  '/api/questions/dismiss': () => ({ kind: 'action', label: 'Closed an unresolved item' }),
