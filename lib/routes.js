...
export const PAGES = [
...

  {
    ...
    group: 'Everyday tools',
    summary:
      'The practice’s own telephone directory, searchable. Every entry is in the page when it opens, so a name — or half of one, or part of a number — filters it as it is typed. Clicking a number copies it; the numbers are shown verbatim from the directory and are never written by the assistant.',
  },
