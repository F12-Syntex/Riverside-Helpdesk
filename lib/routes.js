...
export const PAGES = [
  ...
  },
  {
    ...
    group: 'Practice management',
    summary:
      'The practice’s own written knowledge, in sections and pages with attachments. Every page is read live when a question is answered, so writing a note makes it citable immediately — no re-ingest, no redeploy. Every page has its own link, /notebook/<page-title>-<id>, to paste into a message or bookmark.',
  },
  {
    path: '/notebook/saves',
