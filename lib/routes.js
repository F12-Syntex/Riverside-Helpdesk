...
export const PAGES = [
  {
    ...
    landing: true,
    summary: 'The landing page. Deliberately short: the two tools staff reach for every day.',
  },
  {
    path: '/helpbot',
    title: 'Practice Q&A',
    ...
    landing: true,
    summary:
      'Ask a question about how the practice works and get an answer written only from the practice’s own documents and Notebook, with a verbatim quote behind every claim. Also holds the Knowledge base tab.',
  },
  {
    path: '/lookup',
  ...
  },
  {
    ...
    hidden: true,
    summary:
      'Everything done in the app — pages opened, questions asked, actions taken and errors hit — grouped by the machine it was done on rather than by IP address. Not linked from the landing page or the menu.',
  },
  {
    path: '/knowledge',
...
export const API_ROUTES = [
  ...
  },
  {
    ...
    summary:
      'Writes the one-line filing title for a pasted document or screenshot, reading the practice’s own "Document coding" Notebook section for how sources and departments are named here.',
  },
