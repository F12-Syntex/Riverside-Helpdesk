...
//
// Notes live in Postgres (see ensureNotebookSchema in lib/db.js). Each changed
// page is mirrored into canonical passages immediately; embeddings and atomic
// claims continue after the response, with no re-ingest or redeploy.
