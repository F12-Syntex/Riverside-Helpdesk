...
import { drainKnowledgeAnalysisJobs, enqueueKnowledgeAnalysis, kickKnowledgeAnalysisWorker, knowledgeId, refreshConflicts, syncKnowledgeClaims, upsertKnowledgeEntry } from './knowledge';
...
const SOURCE_KEY = 'bundled-knowledge-v2';
...
export async function ensureBundledKnowledge({ force = false } = {}) {
  ...
  currentPromise = (async () => {
    ...
    const fingerprint = fingerprintOf([
      'schema-v3', manifestText, JSON.stringify(directory),
