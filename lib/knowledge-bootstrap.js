...
import { CATALOG_PATH, EMBEDDINGS_PATH, MANIFEST_PATH } from '@/rag/lib/config.mjs';
import { readChunksText } from '@/rag/lib/chunk-artifact.mjs';
...
export async function ensureBundledKnowledge({ force = false } = {}) {
  ...
  currentPromise = (async () => {
    ...
    // Documents too: the ones synced while document embedding was switched
    // off have no vector, and the semantic arm of /practice cannot see them.
    await fillMissingKnowledgeEmbeddingsByKind('document');
