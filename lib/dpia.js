    ...
    },
    {
      ...
      table: {
        ...
        rows: [
          ...
          { risk: 'Patient details entered into a question.', options: 'On-screen “never enter patient information” warning (in place); automatic screening that removes names and addresses from a question before it is sent, in the browser and again at the endpoint, with the reader told what was taken (in place); the same screening for dates of birth and NHS numbers (to do); stop storing question text in the audit log, or shorten and time-limit it (to do); time-limit the question log, which keeps the question and the answer in full (to do).', effect: 'Reduced', residual: 'High', approved: 'No' },
