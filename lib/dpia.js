    ...
    },
    {
      ...
      table: {
        ...
        rows: [
          ...
          { risk: 'Identifiers left in text pasted into the reception helpers.', options: 'Instruction to remove identifiers before pasting (in place); nothing is stored server-side (in place); names and addresses redacted out of a typed question before the call (in place); the same redaction for text pasted in as an attached document, and for the Signpost, Reason and Code a document boxes (to do); confirm the lawful basis and privacy-notice cover for this processing in the IG review (to do).', effect: 'Reduced', residual: 'Medium', approved: 'No' },
