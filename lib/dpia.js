  ...
  steps: [
    ...
    },
    {
      ...
      body: [
        ...
        'Purposes: To help staff find the correct practice procedure quickly and consistently, and to keep the practice’s working knowledge in one place that the assistant can use. This improves accuracy and saves time, with no intended effect on any patient’s data.',
      ],
    },
    {
      n: 3,
    ...
    },
    {
      ...
      body: [
        'Lawful basis to be confirmed by the practice: for staff data, the basis is expected to be the practice’s legitimate interest in running an efficient service / performance of the employment relationship. The processing achieves the purpose and only minimal data is used: for the Q&A assistant, only the question plus the matching extracts, never the whole knowledge base. Function creep is limited by strict grounding (answers come only from practice documents) and a fixed, declared purpose. Individuals’ rights over staff data are handled through the practice’s existing data-protection policies. Processor compliance is addressed by pinning the provider routing to zero-retention providers; the geographic location of those providers and a written data-processing assurance are still to be confirmed.',
      ],
    },
    {
      n: 5,
