    ...
    },
    {
      ...
      table: {
        ...
        rows: [
          ...
          { source: 'A staff member types patient details into a question. The text goes to the AI provider and is stored in the audit log and, for cacheable questions, verbatim in the answer cache.', likelihood: 'Possible', severity: 'Severe', overall: 'High' },
          ...
          { source: 'The audit log keeps the text staff typed, with no retention limit, no purge job and no deletion route, so it accumulates indefinitely.', likelihood: 'Probable', severity: 'Significant', overall: 'Medium' },
    ...
    },
    {
      ...
      table: {
        ...
        rows: [
          ...
          { risk: 'Patient details entered into a question.', options: 'On-screen “never enter patient information” warning (in place); automatic screening to catch and block identifiers before a question is sent (to do); stop storing question text in the audit log, or shorten and time-limit it (to do).', effect: 'Reduced', residual: 'High', approved: 'No' },
          ...
          { risk: 'Audit log grows for ever and holds typed text.', options: 'Set a retention period and add a purge job and a deletion route (to do); decide whether question text needs to be stored at all, or only its length (to do).', effect: 'Reduced', residual: 'Medium', approved: 'No' },
