...
export const ROLE_KEYS = ['reasoning', 'fast', 'web', 'vision'];
...
export const ROLES = [
  ...
  },
  {
    key: 'vision',
    name: 'Vision',
    used: 'Reading a pasted image or screenshot.',
    wants: 'Must be vision-capable. Left unset it uses the reasoning model, which then has to be vision-capable itself.',
  },
];
...
export const ROLE_SETTING_KEY = { fast: 'ai_model_fast', web: 'ai_model_web', vision: 'ai_model_vision' };
