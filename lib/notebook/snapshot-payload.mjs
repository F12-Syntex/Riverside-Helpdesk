...
export function normalisePayload(data) {
  ...
  return {
    ...
    notes: notes.map((n) => ({
      ...
      // What shape answers from this folder come back in. A backup that predates
      // output tags has none, and '' is exactly right for those.
      outputTag: String(n.outputTag || ''),
    })),
