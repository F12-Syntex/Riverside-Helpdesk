...
import { LABELS, LABEL_ALIASES } from './rules.mjs';
...
export function buildCoherencePrompt(candidates) {
  ...
  return [
    ...
    '',
    'Being on different pages is not itself a disagreement, and a practice recording the same thing twice is not a disagreement. Return one finding for EVERY pair id, and nothing for ids that are not listed.',
    '',
    'THE PAIRS',
    '',
