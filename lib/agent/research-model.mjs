 ...
 * escalate to), and never after a hand-off, which is a decision the loop reached
 * on purpose.
 */
export function shouldEscalateResearch({ error = null, toolCalls = 0, handOff = '', model = '', reasoning = '' }) {
  if (!reasoning || model === reasoning) return NO_ESCALATION;
  if (handOff) return NO_ESCALATION;
