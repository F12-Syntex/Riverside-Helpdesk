...
export const COMMANDS = [
  ...
  },
  {
    ...
    summary: 'Search the NEL Local Contract Specifications',
    detail: 'Searches one document — Primary Care IT’s NEL Local Contract Specifications — and answers with the EMIS Web template(s) for a contract, and the build status they had when PCIT last reported. Works from a template’s name too. Nothing else is searched.',
