...
const JSON_SHAPE =
  ...
  + '<span style="color:#ff7b72">red for never-do or emergency actions</span>, <span style="color:#56c98a">green for always-do confirmations</span>, <span style="color:#e0554f">the accent colour for key informational callouts</span>; <u>underline</u> and <kbd>keyboard keys</kbd> where useful.\n'
