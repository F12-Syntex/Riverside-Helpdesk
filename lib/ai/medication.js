...
const SYSTEM_INTRO =
  ...
  + 'NEVER invent a source URL or a quote. Every quote MUST be copied word for word from a page you actually retrieved with the search tool. If you cannot find authoritative information for the medicine (for example it is not a real medicine, or the name is misspelt), set "found" to false and say so briefly.';
