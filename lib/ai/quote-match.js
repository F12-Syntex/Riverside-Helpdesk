// Verbatim-quote matching primitives shared by the grounding logic in the
// practice-document answer (lib/agent/practice-answer.mjs), the Notebook
// checks and the Medication Check tool (web sources).
