...
export function buildRotaChatPrompt({ staff, weekStarting, grid, times, message, minStaff = 2 }) {
  ...
  return [
    ...
    '  F = full day (7:45–6:30) — usually a temporary staff member; keep F days as F unless asked to change them',
    ...
    '}',
    'Include every staff id in "grid". Keep AL days as AL and F days as F. Use only the codes E, L, F, OFF, AL.',
  ].join('\n');
}
