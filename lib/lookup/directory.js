...
const RULES = [
  ...
  ['IT & systems', /\bemis\b|docman|smart ?card|it helpdesk|it tech|egton|apollo|open exeter|\bpce\b/i],
  ['Mental health', /mental health|crisis line|talking therap|psycholog|tavistock/i],
  ['Community & district nursing', /nurse|matron|d\/n|\bacn\b|midwife|health visitor|tissue viability/i],
  ['Social care & advocacy', /social|advocate|advocacy|language line|learning disabilit|safeguard/i],
  ['Pharmacies & supplies', /pharmac|prescription|gloves|sharps|incontinence pads|wheel|specsavers|hearing|audiology|eye test/i],
