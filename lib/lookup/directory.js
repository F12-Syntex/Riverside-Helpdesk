...
// The practice's own hospital shortlist, on its own.
//
// Fifteen curated rows with verified switchboard numbers — the sites
// reception actually rings. The lookup page opens on these rather than on
// a paragraph about the register: real entries, in the same rows a search
// returns, so the page opens with its content like every other page in
// the app does.
